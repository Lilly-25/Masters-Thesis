...
class hgnn_kpi2d_trainer:
    ...
    def _train_epoch(self):
        ...
        for batch in self.train_loader:
            ...
            batch_y1 = batch.mgrenz_values##Rename
            # batch_y2 = batch.eta_values##Rename
            
            self.optimizer.zero_grad()
            y1_pred, y2_pred  = self.model(
                    batch.x_dict,
            ...
            train_loss_y1 += loss_y1.item() * batch.size(0) 
            train_loss_y2 += loss_y2.item() * batch.size(0)
