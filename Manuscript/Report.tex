...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \textbf{KPI Creator} in terms of dimensions and is plotted.
    \end{enumerate}    
...
parametric description. Vivek \textit{et al.} in Ref. \cite{VAE-MT-2022} also highlights that predicting \ac{KPI}s with tabular data is significantly more efficient than 
...
\begin{enumerate}[nosep]
    ...
    Since these are \ac{FEA} simulations, it is probably an effect of a post processing step taken by the EM Design creator.
...
As the number of cores decrease the simulation would take minutes to hours to converge. Additionally, it is the \ac{FEA} Solver in the block that is the culprit of 
consuming time. \\
