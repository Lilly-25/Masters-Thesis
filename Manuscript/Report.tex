...
\begin{acronym}[TDMA]
    ...
    \acro{IPSM}{Interior Permanent Synchronous Motor}
...
Figure {fig:Y1 Evaluation Statistics MLP} shows the score statistics of the model performance of Torque \ac{KPI} over the entire test dataset.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{./ReportImages/score_MLP_y2.png } 
