...
def eval_plot_kpi3d(nn, mm1, eta1, mm2, eta2, filename):
    ...
    # print(f"Original data - Min: {np.nanmin(Z1):.2f}, Max: {np.nanmax(Z1):.2f}, Mean: {np.nanmean(Z1):.2f}")
    # print(f"Predicted data - Min: {np.nanmin(Z2):.2f}, Max: {np.nanmax(Z2):.2f}, Mean: {np.nanmean(Z2):.2f}")
...
def y2_score(nn, mm1, eta1, mm2, eta2):
    ...
    # print(f"Predicted data - Min: {np.nanmin(Z2):.2f}, Max: {np.nanmax(Z2):.2f}, Mean: {np.nanmean(Z2):.2f}")
    # print(f"Difference - Min: {np.nanmin(Z_diff):.2f}, Max: {np.nanmax(Z_diff):.2f}, Mean: {np.nanmean(Z_diff):.2f}")
    # print(f"Standard deviation: {score:.4f}")
